const projectList = [
  {
    id: 1,
    name: "Codify",
    description: "A platform facilitating hosting, discovery, and exploration of developer portfolios, projects, social links, and resumes.",
    techStack: [],
    github: "https://github.com/bennysuf/Codify",
    video: "https://youtu.be/0M-XUoCHVUk",
  },
  {
    id: 2,
    name: "Moms Cookbook",
